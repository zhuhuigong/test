...
namespace DuiLib
{
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_SCROLLBAR) == 0)
    ...
    {
        if (lstrcmpi(pstrName, _T("button1normalimage")) == 0)
        {
            SetButton1NormalImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button1hotimage")) == 0)
        {
            SetButton1HotImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button1pushedimage")) == 0)
        {
            SetButton1PushedImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button1disabledimage")) == 0)
        {
            SetButton1DisabledImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button2normalimage")) == 0)
        {
            SetButton2NormalImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button2hotimage")) == 0)
        {
            SetButton2HotImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button2pushedimage")) == 0)
        {
            SetButton2PushedImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("button2disabledimage")) == 0)
        {
            SetButton2DisabledImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("thumbnormalimage")) == 0)
        {
            SetThumbNormalImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("thumbhotimage")) == 0)
        {
            SetThumbHotImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("thumbpushedimage")) == 0)
        {
            SetThumbPushedImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("thumbdisabledimage")) == 0)
        {
            SetThumbDisabledImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("railnormalimage")) == 0)
        {
            SetRailNormalImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("railhotimage")) == 0)
        {
            SetRailHotImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("railpushedimage")) == 0)
        {
            SetRailPushedImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("raildisabledimage")) == 0)
        {
            SetRailDisabledImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("bknormalimage")) == 0)
        {
            SetBkNormalImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("bkhotimage")) == 0)
        {
            SetBkHotImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("bkpushedimage")) == 0)
        {
            SetBkPushedImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("bkdisabledimage")) == 0)
        {
            SetBkDisabledImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("hor")) == 0)
        {
            SetHorizontal(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else if (lstrcmpi(pstrName, _T("linesize")) == 0)
        {
            SetLineSize(_ttoi(pstrValue));
        }
        else if (lstrcmpi(pstrName, _T("range")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("showbutton1")) == 0)
        {
            SetShowButton1(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else if (lstrcmpi(pstrName, _T("showbutton2")) == 0)
        {
            SetShowButton2(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else
        {
