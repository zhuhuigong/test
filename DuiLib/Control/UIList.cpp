...
namespace DuiLib {
    ...
    {
        if (lstrcmpi(pstrName, _T("header")) == 0)
        {
            GetHeader()->SetVisible(lstrcmpi(pstrValue, _T("hidden")) != 0);
        }
        else if (lstrcmpi(pstrName, _T("headerbkimage")) == 0)
        {
            GetHeader()->SetBkImage(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("scrollselect")) == 0)
        {
            SetScrollSelect(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else if (lstrcmpi(pstrName, _T("multiexpanding")) == 0)
        {
            SetMultiExpanding(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else if (lstrcmpi(pstrName, _T("itemfont")) == 0)
        {
            m_ListInfo.nFont = _ttoi(pstrValue);
        }
        else if (lstrcmpi(pstrName, _T("itemalign")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("itemendellipsis")) == 0)
        {
        ...
        if (lstrcmpi(pstrName, _T("itemtextpadding")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("itemaltbk")) == 0)
        {
            SetAlternateBk(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        ...
        {
            SetItemShowHtml(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else
        {
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_LISTHEADER) == 0)
            return this;
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_LISTHEADERITEM) == 0)
            return this;
    ...
    {
        if (lstrcmpi(pstrName, _T("dragable")) == 0)
        {
            SetDragable(lstrcmpi(pstrValue, _T("true")) == 0);
        }
        else if (lstrcmpi(pstrName, _T("sepwidth")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("pushedimage")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("sepimage")) == 0)
        {
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_LISTITEM) == 0)
            return static_cast<IListItemUI*>(this);

        if (lstrcmpi(pstrName, DUI_CTR_LISTELEMENT) == 0)
    ...
    {
        if (lstrcmpi(pstrName, _T("selected")) == 0)
            Select();
        else
            CControlUI::SetAttribute(pstrName, pstrValue);
    }
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_LISTLABELELEMENT) == 0)
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_LISTTEXTELEMENT) == 0)
    ...
    LPVOID CListContainerElementUI::GetInterface(LPCTSTR pstrName)
    {
        ...
        if (lstrcmpi(pstrName, DUI_CTR_LISTCONTAINERELEMENT) == 0)
