...
namespace DuiLib
{
    ...
    {
        if (lstrcmpi(pstrName, DUI_CTR_PROGRESS) == 0)
    ...
    {
        if (lstrcmpi(pstrName, _T("foreimage")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("min")) == 0)
        {
            SetMinValue(_ttoi(pstrValue));
        }
        else if (lstrcmpi(pstrName, _T("max")) == 0)
        {
        ...
        else if (lstrcmpi(pstrName, _T("isstretchfore")) == 0)
        {
            SetStretchForeImage(lstrcmpi(pstrValue, _T("true")) == 0 ? true : false);
        }
        else
        {
