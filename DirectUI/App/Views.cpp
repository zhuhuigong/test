...
LPCTSTR CConfigurePageWnd::GetDialogResource() const
{
    return "<Dialog>"
        ...
        "<NavigatorButton name=\"page_registers\" text=\"<i 4> Registre\" tooltip=\"Vis forskellige registre\" />"
        "<NavigatorButton name=\"page_systems\" text=\"<i 4> Systemer\" />"
        "<NavigatorButton name=\"page_configure\" text=\"<i 4> Ops鎡ning\" selected=\"true\" />"
        "<NavigatorButton name=\"page_reports\" text=\"<i 4> Rapporter\" />"
        "</NavigatorPanel>"
        "</VerticalLayout>"
        "<VerticalLayout>"
        "<Toolbar>"
        "<LabelPanel align=\"right\" text=\"<f 6><c #fffe28>System Ops鎡ning</c></f>\" />"
        "</Toolbar>"
        "<ToolbarTitlePanel name=\"titlepanel\" text=\"<f 7>System Ops鎡ning</f>\" />"
        "<TitleShadow />"
        "<WindowCanvas>"
        "<VerticalLayout>"
        ...
        "<VerticalLayout>"
        "<TextPanel text=\"<f 6><c #2c4378>Ops鎡ningsliste</c></f>\" />"
        "<SeparatorLine />"
        ...
        "<ListLabelElement text=\"<i 4> Chauff鴕 register\" />"
...
LPCTSTR CSystemsPageWnd::GetDialogResource() const
{
    return "<Dialog>"
        ...
        "<VerticalLayout>"
        "<DialogLayout scrollbar=\"true\" >"
        "<LabelPanel pos=\"0, 0, 80, 24\" text=\"<b>&S鴊 efter</b>\" stretch=\"group\" />"
        "<SingleLineEdit pos=\"80, 2, 220, 22\" name=\"navn\" stretch=\"size_x\" />"
        "<Button pos=\"224, 2, 265, 22\" text=\"S鴊\" name=\"ok\" stretch=\"move_x\" />"
...
LPCTSTR CReportsPageWnd::GetDialogResource() const
{
    return "<Dialog>"
        ...
        "<TextPanel text=\"<i 2 50><a><f 6>Chauff鴕 Rapporter</f></a>\n<h>\n<c #444540>Rapporter for chauff鴕er registeret.\" />"
...
LPCTSTR CSearchPageWnd::GetDialogResource() const
{
    return "<Dialog caption=\"Search Page\" >"
        "<VerticalLayout>"
        "<ToolbarTitlePanel text=\"<f 6>S鴊 efter en vej.</f><p><x 10>Indtast s鴊ekriterier og s鴊 efter vejen.\" />"
        "<DialogCanvas>"
        "<VerticalLayout>"
        "<DialogLayout>"
        ...
        "</DropDown>"
        "<LabelPanel pos=\"0, 36, 60, 60\" text=\"S鴊\" stretch=\"group\" />"
        "<SingleLineEdit pos=\"60, 38, 250, 58\" name=\"search\" text=\"\" stretch=\"size_x\" />"
        "<Button pos=\"260, 38, 340, 58\" name=\"ok\" text=\"&S鴊\" stretch=\"move_x\" />"
...
LPCTSTR CEditPageWnd::GetDialogResource() const
{
    return "<Dialog caption=\"Rediger Person\" >"
        ...
        "<SingleLinePick pos=\"110, 62, 240, 82\" text=\"<i 3><a>Bjarke Viks鴈</a>\" stretch=\"size_x\" />"
        ...
        "<SingleLinePick pos=\"110, 132, 240, 152\" text=\"<a>N鴕rebred, Vallensb鎘</a>\" stretch=\"size_x\" />"
        "<LabelPanel pos=\"260, 130, 370, 154\" text=\"Note\" stretch=\"move_x\" />"
        "<MultiLineEdit pos=\"370, 132, 510, 192\" text=\"Dette er en meget lang note omkring denne person. Her f鴏ger noget mere tekst\" stretch=\"move_x size_x\" />"
        ...
        "<ListLabelElement text=\"2625 Vallensb鎘\" />"
        "</DropDown>"

        "<Option pos=\"0, 192, 120, 212\" text=\"Husnr kr鎣et\" selected=\"true\" />"
        "<Option pos=\"120, 192, 240, 212\" text=\"Ikke kr鎣et\" />"
        "</DialogLayout>"
        "</TabPage>"
...
LPCTSTR CPopupWnd::GetDialogResource() const
{
    return "<Dialog>"
        ...
        "<DialogCanvas>"
        "<VerticalLayout>"
        "<TextPanel text=\"Det er ikke altid godt at trykke p?linket. Du kan fortryde dit klik ved at v鎙ge Nej knappen.\" />"
        "<PaddingPanel />"
        "<DialogLayout>"
        "<PaddingPanel pos=\"0, 0, 340, 4\" />"
        "<SeparatorLine  pos=\"0, 4, 340, 18\" stretch=\"group size_x\" />"
